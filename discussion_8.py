...
def getAdmissionsInfo2019(soup):
    tags= soup.find_all('College/school founding')
    collect_info = []
    for tag in tags:
        info = tag.text
        collect_info.append(info)
...
def main():
    ...
    #### YOUR CODE HERE####
    soup= BeautifulSoup(requests.get('https://en.wikipedia.org/wiki/University_of_Michigan').text, 'html.parser')
